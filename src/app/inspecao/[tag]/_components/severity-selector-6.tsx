...
export function SeveritySelector6({ value, onChange, disabled = false }: Props) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <span className="text-sm font-semibold text-red-200">Severidade da inspeção (1–6)</span>
      <div className="flex flex-wrap items-center gap-2" role="group" aria-label="Selecionar severidade da inspeção">
        {OPTIONS.map(option => {
