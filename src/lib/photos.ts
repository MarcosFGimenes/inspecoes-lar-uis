...
export type StoredImage = StoredPhoto;
...
// Preserve previous named export for compatibility with older code paths.
export const normalizeStoredImages = normalizeStoredPhotos;
